...
exports.TokenNotProvided = exports["default"] = void 0;
...
var SpotifyWrapper = /*#__PURE__*/function () {
  function SpotifyWrapper() {
    ...
    this.apiURL = (_options$apiURL = options.apiURL) !== null && _options$apiURL !== void 0 ? _options$apiURL : _config.API_URL;
...
var TokenNotProvided = /*#__PURE__*/function (_Error) {
  _inherits(TokenNotProvided, _Error);

  var _super = _createSuper(TokenNotProvided);

  function TokenNotProvided() {
    _classCallCheck(this, TokenNotProvided);

    return _super.call(this, 'Should token be provided to SpotifyWrapper constructor');
  }
